...
const content = {
  es: {
    ...
    faqs: [
      ...
      { q: "Cual es la diferencia entre subir una foto y usar mi avatar?", a: "Si subes una foto directamente en el panel de elementos, la IA la usara como referencia visual pero le dara prioridad al prompt que describes. Si configuras tu avatar en la seccion de perfil y usas 'Usar mi cara', la IA mantendra tus rasgos faciales con mayor precision en la miniatura final. Por eso la generacion con cara cuesta 1 credito mas que solo fondo." },
      ...
      { q: "Como protegen mis imagenes de contenido inapropiado?", a: "ThumbsLatam utiliza Amazon Rekognition, tecnologia de inteligencia artificial certificada por Amazon Web Services, para analizar y moderar automaticamente todas las imagenes subidas por los usuarios. Esto garantiza que no se procese contenido explicito, inapropiado o que viole nuestras politicas de uso." },
      ...
      { q: "Puedo cancelar mi plan?", a: "Si. Puedes cancelar desde tu dashboard en la seccion Plan actual > Cancelar suscripcion. Seras redirigido a Gumroad donde puedes confirmar la cancelacion. Mantendras acceso hasta el final del periodo pagado. Tus creditos restantes seguiran disponibles hasta esa fecha." },
      { q: "Las imagenes del plan gratis tienen marca de agua?", a: "Si. Las imagenes generadas con el plan gratuito incluyen una marca de agua de ThumbsLatam en la esquina inferior. Al suscribirte a un plan Pro o Studio, todas tus generaciones seran sin marca de agua." },
      { q: "Que pasa si intento generar contenido prohibido?", a: "Si intentas generar contenido que viola nuestras politicas 3 veces, tu cuenta sera suspendida automaticamente por 24 horas. Tras ese periodo, se reactivara automaticamente. Reincidencias pueden resultar en suspension permanente." },
    ...
    terms_updated: "Ultima actualizacion: abril 2026",
    terms: [
      ...
      { h: "4. Propiedad de las imagenes", p: "Las imagenes que generas son de tu propiedad y puedes usarlas con fines personales y comerciales. Las imagenes generadas con el plan gratuito incluyen una marca de agua de ThumbsLatam. Las imagenes generadas con planes pagos Pro o Studio no incluyen marca de agua." },
      { h: "5. Uso aceptable", p: "Queda prohibido generar contenido ilegal, ofensivo o que infrinja derechos de terceros. El usuario es el unico responsable del contenido que genera. Tres intentos de generar contenido prohibido resultaran en la suspension automatica de la cuenta por 24 horas. Reincidencias pueden resultar en suspension permanente sin reembolso." },
      { h: "6. Moderacion de contenido", p: "ThumbsLatam implementa filtros tecnicos y revision manual para prevenir la generacion de contenido prohibido. Queda estrictamente prohibido generar contenido adulto, sexual, violento, que represente menores, que suplante identidades de personas reales sin consentimiento, o cualquier contenido que viole leyes aplicables. Todas las imagenes generadas son privadas y solo accesibles por el usuario que las creo. ThumbsLatam se reserva el derecho de suspender cuentas que violen estas politicas." },
      { h: "7. Cancelacion y reembolsos", p: "Puedes cancelar en cualquier momento. Ofrecemos reembolso completo dentro de los primeros 7 dias si no has usado creditos. Escribe a soporte@thumbslatam.com con asunto Solicitud de reembolso." },
      { h: "8. Limitacion de responsabilidad", p: "ThumbsLatam no garantiza resultados especificos. El servicio se ofrece tal cual, sin garantias implicitas." },
      { h: "9. Modificaciones", p: "ThumbsLatam puede modificar estos terminos en cualquier momento. Los cambios se notificaran por correo o aviso en la plataforma." },
    ],
    privacy_title: "Politica de privacidad",
    privacy_updated: "Ultima actualizacion: abril 2026",
    privacy: [
      ...
      { h: "3. Tu foto de perfil", p: "La foto que subes se almacena de forma segura y se usa unicamente para generar tus imagenes. No la compartimos con terceros ni la usamos para entrenar modelos de IA. Todas las imagenes subidas son analizadas automaticamente por Amazon Rekognition para detectar y bloquear contenido explicito o inapropiado antes de ser procesadas." },
  ...
  en: {
    ...
    faqs: [
      ...
      { q: "What is the difference between uploading a photo and using my avatar?", a: "If you upload a photo directly in the elements panel, the AI will use it as a visual reference but will prioritize the prompt you describe. If you set up your avatar in the profile section and use 'Use my face', the AI will preserve your facial features with greater precision in the final thumbnail. That is why face generation costs 1 extra credit compared to background only." },
      ...
      { q: "How do you protect against inappropriate content in images?", a: "ThumbsLatam uses Amazon Rekognition, an AI technology certified by Amazon Web Services, to automatically analyze and moderate all images uploaded by users. This ensures that explicit, inappropriate, or policy-violating content is never processed." },
      ...
      { q: "Can I cancel my plan?", a: "Yes. You can cancel from your dashboard in the Plan section > Cancel subscription. You will be redirected to Gumroad to confirm the cancellation. You will keep access until the end of the paid period. Your remaining credits will stay available until that date." },
      { q: "Do free plan images have a watermark?", a: "Yes. Images generated with the free plan include a ThumbsLatam watermark in the lower corner. By subscribing to a Pro or Studio plan, all your generations will be watermark-free." },
      { q: "What happens if I try to generate prohibited content?", a: "If you attempt to generate content that violates our policies 3 times, your account will be automatically suspended for 24 hours. After that period, it will reactivate automatically. Repeat violations may result in permanent suspension." },
    ...
    terms: [
      ...
      { h: "4. Ownership of images", p: "The images you generate are your property and you can use them for personal and commercial purposes. Images generated with the free plan include a ThumbsLatam watermark. Images generated with paid Pro or Studio plans do not include a watermark." },
      { h: "5. Acceptable use", p: "It is prohibited to generate illegal, offensive content or content that infringes third party rights. The user is solely responsible for the content they generate. Three attempts to generate prohibited content will result in automatic account suspension for 24 hours. Repeat violations may result in permanent suspension without refund." },
      { h: "6. Content moderation", p: "ThumbsLatam implements technical filters and manual review to prevent the generation of prohibited content. It is strictly prohibited to generate adult, sexual, violent content, content depicting minors, content impersonating real individuals without consent, or any content that violates applicable laws. All generated images are private and only accessible by the user who created them. ThumbsLatam reserves the right to suspend accounts that violate these policies." },
      { h: "7. Cancellation and refunds", p: "You can cancel at any time. We offer a full refund within the first 7 days if you have not used credits. Write to soporte@thumbslatam.com with subject Refund Request." },
      { h: "8. Limitation of liability", p: "ThumbsLatam does not guarantee specific results. The service is provided as is, without any implied warranties." },
      { h: "9. Modifications", p: "ThumbsLatam may modify these terms at any time. Changes will be notified by email or notice on the platform." },
    ],
    ...
    privacy: [
      ...
      { h: "3. Your profile photo", p: "The photo you upload is stored securely and used only to generate your images. We do not share it with third parties or use it to train AI models. All uploaded images are automatically analyzed by Amazon Rekognition to detect and block explicit or inappropriate content before processing." },
