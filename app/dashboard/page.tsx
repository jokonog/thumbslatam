      ...
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"12px",marginBottom:"24px"}}>
        ...
        {creditos !== null && creditos < 6 ? (
          <div style={{background:"rgba(255,77,0,0.08)",border:"1px solid rgba(255,77,0,0.25)",borderRadius:"12px",padding:"16px",display:"flex",flexDirection:"column",justifyContent:"center"}}>
            ...
            <div style={{display:"flex",gap:"8px"}}>
              <button id="btn-pro" onClick={() => abrirCheckout("pro")} onMouseEnter={() => { document.getElementById("btn-pro")!.style.background="#FF4D00"; document.getElementById("btn-pro")!.style.color="white"; document.getElementById("btn-studio")!.style.background="transparent"; document.getElementById("btn-studio")!.style.color="#8B8FA8"; document.getElementById("btn-studio")!.style.border="1px solid #3A3D52"; }} onMouseLeave={() => { document.getElementById("btn-pro")!.style.background="#FF4D00"; document.getElementById("btn-studio")!.style.background="transparent"; document.getElementById("btn-studio")!.style.color="#FF4D00"; document.getElementById("btn-studio")!.style.border="1px solid #FF4D00"; }} style={{flex:1,padding:"7px",borderRadius:"8px",background:"#FF4D00",border:"none",color:"white",fontWeight:"700",fontSize:"0.75rem",cursor:"pointer",transition:"all 0.2s"}}>
                Pro $10/mes →
              </button>
              <button id="btn-studio" onClick={() => abrirCheckout("studio")} onMouseEnter={() => { document.getElementById("btn-studio")!.style.background="#FF4D00"; document.getElementById("btn-studio")!.style.color="white"; document.getElementById("btn-studio")!.style.border="1px solid #FF4D00"; document.getElementById("btn-pro")!.style.background="transparent"; document.getElementById("btn-pro")!.style.color="#8B8FA8"; document.getElementById("btn-pro")!.style.border="1px solid #3A3D52"; }} onMouseLeave={() => { document.getElementById("btn-studio")!.style.background="transparent"; document.getElementById("btn-studio")!.style.color="#FF4D00"; document.getElementById("btn-pro")!.style.background="#FF4D00"; document.getElementById("btn-pro")!.style.color="white"; }} style={{flex:1,padding:"7px",borderRadius:"8px",background:"transparent",border:"1px solid #FF4D00",color:"#FF4D00",fontWeight:"700",fontSize:"0.75rem",cursor:"pointer",transition:"all 0.2s"}}>
                Studio $25/mes →
              </button>
            </div>
          </div>
