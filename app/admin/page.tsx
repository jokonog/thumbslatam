    ...
    <main style={{minHeight:"100vh",background:"#060810",color:"white",padding:"32px 24px",maxWidth:"900px",margin:"0 auto"}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"32px"}}>
        ...
        <div style={{display:"flex",gap:"8px",alignItems:"center"}}>
          ...
          <a href="/admin/simulador" style={{fontSize:"0.8rem",color:"#FF4D00",background:"rgba(255,77,0,0.08)",border:"1px solid rgba(255,77,0,0.3)",padding:"6px 12px",borderRadius:"8px",cursor:"pointer",textDecoration:"none",marginRight:"8px",fontWeight:600,transition:"all 0.2s ease"}} onMouseEnter={(e) => { e.currentTarget.style.background = "#FF4D00"; e.currentTarget.style.color = "#fff"; e.currentTarget.style.borderColor = "#FF4D00"; }} onMouseLeave={(e) => { e.currentTarget.style.background = "rgba(255,77,0,0.08)"; e.currentTarget.style.color = "#FF4D00"; e.currentTarget.style.borderColor = "rgba(255,77,0,0.3)"; }}>Simulador</a><button onClick={() => { document.cookie = "admin-session=; maxAge=0; path=/"; setStep("login"); }} style={{fontSize:"0.8rem",color:"#8B8FA8",background:"none",border:"1px solid #3A3D52",padding:"6px 12px",borderRadius:"8px",cursor:"pointer"}}>Cerrar sesion</button>
        </div>
      </div>
